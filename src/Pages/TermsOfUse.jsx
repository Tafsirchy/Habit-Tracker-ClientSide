        ...
        <div className="max-w-4xl mx-auto bg-[var(--color-bg-primary)] rounded-lg shadow-lg border border-[var(--color-border)] p-8">
          ...
          <div className="space-y-8 text-[var(--color-text-secondary)]">
            <section>
              ...
              <p className="mb-4">
                By accessing and using the Habit Tracker website and
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                materials (information or software) on Habit Tracker for
            ...
            <section>
              ...
              <p className="mb-4">
                The materials on Habit Tracker are provided on an 'as is' basis.
                Habit Tracker makes no warranties, expressed or implied, and
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                the use or inability to use the materials on Habit Tracker, even
                if Habit Tracker or an authorized representative has been
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                technical, typographical, or photographic errors. Habit Tracker
                does not warrant that any of the materials on its website are
                accurate, complete, or current. Habit Tracker may make changes
            ...
            <section>
              ...
              <p className="mb-4">
                Habit Tracker has not reviewed all of the sites linked to its
                website and is not responsible for the contents of any such
                linked site. The inclusion of any link does not imply
                endorsement by Habit Tracker of the site. Use of any such linked
            ...
            <section>
              ...
              <p className="mb-4">
                Habit Tracker may revise these terms of service for its website
