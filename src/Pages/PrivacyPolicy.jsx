        ...
        <div className="max-w-4xl mx-auto bg-[var(--color-bg-primary)] rounded-lg shadow-lg border border-[var(--color-border)] p-8">
          ...
          <div className="space-y-8 text-[var(--color-text-secondary)]">
            <section>
              ...
              <p className="mb-4">
                Habit Tracker ("we," "us," "our," or "Company") is committed to
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  ...
                  number, and other identifying information you provide
                </li>
                <li>
                ...
                <li>
                  <strong>Habit Data:</strong> Information about your habits,
            ...
            <section>
              ...
              <p className="mb-4">
                Habit Tracker uses the information we collect or receive for the
                following purposes:
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  <strong>By Law or to Protect Rights:</strong> When required by
                  law or to protect our legal rights
                </li>
                <li>
                  <strong>Third-Party Service Providers:</strong> To vendors and
            ...
            <section>
              ...
              <p className="mb-4">
                Habit Tracker does not knowingly collect personal information
                from children under 13. If we discover that a child under 13 has
