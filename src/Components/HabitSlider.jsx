              ...
              <div className="w-11/12 mx-auto grid grid-cols-1 md:grid-cols-2 gap-0 h-full">
                ...
                <div className="py-4 sm:py-8 md:py-10 lg:py-14 flex flex-col justify-center text-white order-2 md:order-1">
                  ...
                  <div className="flex flex-wrap gap-2 sm:gap-3 mb-4 sm:mb-6">
                    <button className="bg-white text-[#1B3C53] font-bold px-4 sm:px-6 py-2 sm:py-3 rounded-full text-xs sm:text-sm hover:bg-opacity-90 transition transform hover:scale-105">
                      Start Free Trial
                    </button>
            ...
            <div className="bg-white overflow-hidden shadow-2xl md:min-h-[550px] lg:min-h-[650px] min-h-fit">
              <div className="w-11/12 mx-auto grid grid-cols-1 md:grid-cols-5 min-h-full">
                ...
                <div className="md:col-span-3 px-4 py-6 sm:py-8 sm:px-8 md:p-12 flex flex-col justify-center">
                  ...
                  <h1
                    className="text-3xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#1B3C53] leading-tight 
  ...
  mb-2 sm:mb-2 leading-relaxed"
                  ...
                  <div className="space-y-4 sm:space-y-2 mb-4 sm:mb-4">
                    {[
                      ...
                      <div
                        key={i}
                        className="flex items-center gap-2 text-xs sm:text-sm text-gray-800"
                      >
                        <span>{feature}</span>
                      </div>
                    ))}
